...
/**
 * Email Service
 * Handles sending emails via Gmail using Nodemailer
 */
 ...
 * @param {string} resetToken - Unhashed reset token (sent in URL)
 */
async function sendPasswordResetEmail(to, resetToken) {
    ...
    <body>
      <div class="container">
        ...
        <div class="footer">
          <p>© ${new Date().getFullYear()} Industraders · This is an automated message, do not reply.</p>
        </div>
      </div>
    </body>
    </html>
  `;
    ...
    await transporter.sendMail({
        from: `"Industraders" <${process.env.EMAIL_USER}>`,
        to,
