...
class SalesmanService {
  ...
  async updateSalesman(id, updateData) {
    ...
    const allowedFields = ['name', 'code', 'phone', 'email', 'cnic', 'fatherName', 'guarantorCnic', 'commissionRate', 'routeId', 'warehouseId', 'isActive'];
    ...
    await salesman.populate('warehouseId', 'name code');
