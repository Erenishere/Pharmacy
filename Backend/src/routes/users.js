...
router.patch(
  ...
  [
    ...
    body('permissions.modules')
      .optional()
      .isArray()
      .withMessage('Permissions.modules must be an array'),
    body('permissions.features')
      .optional()
      .isArray()
      .withMessage('Permissions.features must be an array'),
    body('permissions.dataAccess')
      .optional()
      .isObject()
      .withMessage('Permissions.dataAccess must be an object'),
    body('permissions.dataAccess.dimensionBased')
      .optional()
      .isBoolean()
      .withMessage('Permissions.dataAccess.dimensionBased must be a boolean'),
    body('permissions.dataAccess.allowedDimensions')
      .optional()
      .isArray()
      .withMessage('Permissions.dataAccess.allowedDimensions must be an array'),
    validate,
  ],
...
router.get(
  ...
  [
    ...
    query('module')
      ...
      .trim()
      .isLength({ min: 1 })
      .withMessage('Module name must not be empty'),
    query('feature')
      .optional()
      .trim()
      .isLength({ min: 1 })
  ...
  userController.checkUserPermissions,
);
