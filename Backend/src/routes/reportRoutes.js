...
/**
 * @route   GET /api/v1/reports/warehouse-sales
 * @desc    Get warehouse sales report
 * @access  Private
 * @query   startDate, endDate, warehouseId (optional), format (optional)
 */
router.get('/warehouse-sales', requireRoles(['admin', 'accountant', 'manager']), reportController.getWarehouseSales);
