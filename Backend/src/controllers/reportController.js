...
class ReportController {
  ...
  async getSalesReport(req, res, next) {
    try {
      const {
        startDate, endDate, customerId, groupBy, format,
      } = req.query;
  ...
  async getPurchaseReport(req, res, next) {
    try {
      const {
        startDate, endDate, supplierId, groupBy, format,
      } = req.query;
  ...
  async getInventoryReport(req, res, next) {
    try {
      const {
        category, lowStockOnly, includeInactive, format,
      } = req.query;
  ...
  async getPurchaseGSTBreakdown(req, res, next) {
    try {
      const {
        startDate, endDate, supplierId, format,
      } = req.query;
  ...
  async getDiscountBreakdown(req, res, next) {
    try {
      const {
        startDate, endDate, invoiceType, discountType, claimAccountId, format,
      } = req.query;
  ...
  async getTaxSummary(req, res, next) {
    try {
      const {
        startDate, endDate, invoiceType, customerId, supplierId, format,
      } = req.query;
  ...
  async getSchemeAnalysis(req, res, next) {
    try {
      const {
        startDate, endDate, customerId, supplierId, invoiceType, format,
      } = req.query;
  ...
  async getSchemeInvoices(req, res, next) {
    try {
      ...
      const {
        startDate, endDate, invoiceType, format,
      } = req.query;
  ...
  async getSalesmanSalesReport(req, res, next) {
    try {
      const {
        salesmanId, startDate, endDate, format,
      } = req.query;
  ...
  async getSalesmanCommissionReport(req, res, next) {
    try {
      const {
        salesmanId, startDate, endDate, commissionBasis, salesCommissionRate, collectionsCommissionRate, format,
      } = req.query;
  ...
  /**
   * Get warehouse-wise sales revenue (for dashboard)
   */
  async getWarehouseSales(req, res, next) {
    try {
      const { startDate, endDate } = req.query;
      ...
      const report = await analyticsService.getWarehouseSalesAggregation(startDate, endDate);
