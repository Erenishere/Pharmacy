 ...
 */
const handleMongooseCastError = (err) => new ValidationError(
 ...
 * Handle JWT Errors
 */
const handleJWTError = () => new AppError('Invalid authentication token', 401, 'INVALID_TOKEN');

/**
 * Handle JWT Expired Error
 */
const handleJWTExpiredError = () => new AppError('Authentication token has expired', 401, 'TOKEN_EXPIRED');
