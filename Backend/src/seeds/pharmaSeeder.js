  ...
  // --- PAIN RELIEF ---
  {
    ...
    inventory: {
      ...
      batches: [
        ...
        {
          batchNumber: 'BATCH-NEAR-EXP', expiryDate: new Date('2024-03-01'), stock: 20, costPrice: 400, salePrice: 500,
        }, // Near expiry
      ],
    },
    packSize: 200,
...
module.exports = {
  async seed() {
    ...
    const fixedItems = pharmaItems.map(item => ({
      ...item,
