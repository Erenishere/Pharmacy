...
describe('Authentication Integration Tests', () => {
  ...
  beforeAll(async () => {
    ...
    // The database connection is already handled by tests/setup.js
    // We just need to ensure the test user exists
  ...
  afterAll(async () => {
    ...
    // The database disconnection is handled by tests/setup.js
    // We only need to stop the server if it has long-running processes
    // but in tests we typically don't start the full server.start()
  });
